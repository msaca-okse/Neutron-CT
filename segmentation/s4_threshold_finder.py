...
def analyze_element_segmentation(element):
    narrowness_array = [0.7,0.9,1,1.2,1.5,1.8,2.2,3]
    for narrowness in narrowness_array:
        ...
        narrowness_str = f"{narrowness:05.2f}".replace(".", "-")
        fig2.savefig('/dtu-compute/msaca/cache/plots/output_' + index_str+element + '_' + narrowness_str + '.png', dpi = 200)
