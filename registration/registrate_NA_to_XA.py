...
reg.load_images(fixed_array=recon_XA,moving_array=recon_NA)
threshold = [0.02,0.02]
...
readme_name = '/zhome/71/c/146676/main/Transformations/README_registrate_NA_to_XA.txt'
...
path = '/zhome/71/c/146676/main/Transformations/transformation_NA_to_XA.json'
